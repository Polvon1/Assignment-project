...
@section('title',__('main.system-user.index'))
...
@section('content')
                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">{{ __('main.system-user.index') }}</h3>
                            <div class="nk-block-des text-soft">
                                <p>{{ __('main.system-user.total', ['value' => $users->total()]) }}</p>
                            </div>
                        </div>
                        <div class="nk-block-head-content">
                            @can('trash.user')
                                <a href="{{ route('dashboard.system.user.trash') }}"
                                   class="btn btn-icon btn-outline-dark d-md-none"><em
                                        class="icon ni ni-trash"></em></a>
                                <a href="{{ route('dashboard.system.user.trash') }}"
                                   class="btn btn-outline-dark d-none d-md-inline-flex"><em
                                        class="icon ni ni-trash"></em><span>{{ __('action.trashed') }}</span></a>
                            @endcan
                            @can('create.user')
                                <a href="{{ route('dashboard.system.user.create') }}"
                                   class="btn btn-icon btn-primary d-md-none"><em class="icon ni ni-plus"></em></a>
                                <a href="{{ route('dashboard.system.user.create') }}"
                                   class="btn btn-primary d-none d-md-inline-flex"><em
                                        class="icon ni ni-plus"></em><span>{{ __('main.system-user.add') }}</span></a>
                            @endcan
                        </div>
                    </div>
                </div>
                                ...
                                <div class="nk-tb-list nk-tb-ulist">
                                    <div class="nk-tb-item nk-tb-head">
                                        ...
                                        <div class="nk-tb-col tb-col-xxl"><span
                                                class="sub-text">{{ __('role.title') }}</span></div>
                                    ...
                                    @forelse($users as $user)
                                        <div class="nk-tb-item">
                                            ...
                                            <div class="nk-tb-col tb-col-xxl">
                                                @if($user->role_name == \App\Support\Enums\RoleEnum::ADMIN)
                                                ...
                                                <ul class="nk-tb-actions gx-1">
                                                    @can('edit.user')
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{ route('dashboard.system.user.edit',['user' => $user->id]) }}"
    ...
    @foreach($users as $user)
        <form action="{{ route('dashboard.system.user.destroy',['user' => $user->id]) }}" method="POST" class="d-none"
