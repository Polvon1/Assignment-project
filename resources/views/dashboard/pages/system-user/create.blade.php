...
@section('title',__('main.system-user.add'))
                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">{{ __('main.system-user.add') }}</h3>
                        </div>
                    </div>
                </div>
                <div class="nk-block">
                    <form action="{{ route('dashboard.system.user.store') }}" method="POST">
                        @csrf
                        <div class="row">
                                ...
                                <div class="card card-bordered h-100">
                                    <div class="card-inner">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-12 mb-3">
                                                @livewire('region-select-component',['region_id' => old('region_id',''),'district_id' => old('district_id',''),'required' => false])
                                            </div>
                                                    ...
                                                    @forelse($roles as $role)
                                                        <li>
                                                            <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                                <input type="radio" class="custom-control-input" name="role_id" id="role_{{ $role->id }}" required value="{{ $role->id }}">
