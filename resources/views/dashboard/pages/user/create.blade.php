...
@section('title',__('main.user.add'))
                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">{{ __('main.user.add') }}</h3>
                        </div>
                    </div>
                </div>
                <div class="nk-block">
                    <form action="{{ route('dashboard.user.store') }}" method="POST">
                        ...
                        <input type="hidden" value="{{ auth()->user()->organization_id }}" name="organization_id">
                                                ...
                                                <ul class="custom-control-group">
                                                    <li>
                                                        <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                            <input type="radio" class="custom-control-input" name="gender" id="gender_M" required value="M">
                                                            <label class="custom-control-label" for="gender_M">
                                                                <em class="fas fa-mars"></em>
                                                                <span class="ps-2">{{__('main.user.male')}}</span>
                                                            </label>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="custom-control custom-checkbox custom-control-pro no-control">
                                                            <input type="radio" class="custom-control-input" name="gender" id="gender_F" required value="F">
                                                            <label class="custom-control-label" for="gender_F">
                                                                <em class="fas fa-venus"></em>
                                                                <span class="ps-2">{{__('main.user.female')}}</span>
                                                            </label>
                                                        </div>
                                                    </li>
                                                </ul>
