                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">{{ __('main.user.edit') }}</h3>
                        </div>
                    </div>
                </div>
                <div class="nk-block">
                                    ...
                                    <div class="card-inner">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-12 mb-3">
                                                @livewire('region-select-component',['region_id' => old('region_id',$user->region_id),'district_id' => old('district_id',$user->district_id),'required' => true])
                                            </div>
                                                    ...
                                                    <li>
                                                        <div
                                                            ...
                                                            <input type="radio" class="custom-control-input"
                                                                   name="gender" id="gender_M" required value="M" @if($user->profile->gender == "M") checked @endif>
                                                            <label class="custom-control-label" for="gender_M">
                                                                <em class="fas fa-mars"></em>
                                                                <span class="ps-2">Male</span>
                                                            </label>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div
                                                            class="custom-control custom-checkbox custom-control-pro no-control">
                                                            <input type="radio" class="custom-control-input"
                                                                   name="gender" id="gender_F" required value="F" @if($user->profile->gender == "F") checked @endif>
                                                            <label class="custom-control-label" for="gender_F">
                                                                <em class="fas fa-venus"></em>
                                                                <span class="ps-2">Female</span>
                                                            </label>
                                                        </div>
                                                    </li>
                                                </ul>
