...
{{--            <img src="{{ asset('images/logo_white.png') }}" height="24" class="logo-dark-mode" alt="">--}}
        ...
        <div id="navigation">
            ...
            <ul class="navigation-menu nav-light">
                ...
                <li>
                    <a href="{{ route('main.index') }}#how_to_work" class="sub-menu-item">{{ __('landing.menu.how_to_work') }}</a>
                </li>
                <li>
                    <a href="{{ route('main.index') }}#feature" class="sub-menu-item">{{ __('landing.menu.feature') }}</a>
                </li>
                <li>
                    <a href="{{ route('main.index') }}#test" class="sub-menu-item">{{ __('landing.menu.test') }}</a>
                </li>
                <li>
                    <a href="{{ route('main.index') }}#about" class="sub-menu-item">{{ __('landing.menu.about') }}</a>
                </li>
                <li>
                    <a href="{{ route('main.index') }}#contact" class="sub-menu-item">{{ __('landing.menu.contact') }}</a>
                </li>
